...
[查看详情](./12-camera-tft/README.md)

---

### 13. Camera Capture - 摄像头拍照按钮

**难度**: ⭐⭐⭐

**描述**: 在取景器基础上增加拍照按钮，按下拍照并保存
...
[查看详情](./13-camera-photo/README.md)
...
[查看详情](./18-piezo-buzzer/README.md)
...
**描述**: 使用 DHT11 传感器测量温度和湿度

**涉及内容**:
- 数字温湿度传感器原理
- adafruit-circuitpython-dht 库使用
- GPIO 数据读取

[查看详情](./20-dht-sensor/README.md)

---

### 21. DIY Camera - DIY 相机

**难度**: ⭐⭐⭐⭐⭐

**描述**: 综合项目，集成摄像头、屏幕、旋钮、按键构建完整相机
